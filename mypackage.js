/**
 * @fileOverview The main program for "mypackage".  This where the exported entities reside.
 ...
 * @namespace Meteor.mypackage
 */
Meteor.methods({
  /**
   * Get a pet by its nrecord id.
   * @name getPetById
   * @memberof Meteor.mypackage
   * @method
   ...
   * @returns {json}
   */
  mypackage_getPetById: function getPetById(petNum) {
